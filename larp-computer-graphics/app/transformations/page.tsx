...
const DEMOS: Demo[] = [
  ...
  { name: 'Horizontal Expansion', m: [[2, 0], [0, 1]], display: [['k', '0'], ['0', '1']], desc: 'Scales x by factor k (shown: k = 2)', gif:"/demos/Expansion.gif"},
  { name: 'Vertical Expansion', m: [[1, 0], [0, 2]], display: [['1', '0'], ['0', 'k']], desc: 'Scales y by factor k (shown: k = 2)' },
  { name: 'Horizontal Shear', m: [[1, 0], [1, 1]], display: [['1', '0'], ['k', '1']], desc: 'Slants shape horizontally (shown: k = 1)', gif:"/demos/Shear.gif" },
  { name: 'Vertical Shear', m: [[1, 1], [0, 1]], display: [['1', 'k'], ['0', '1']], desc: 'Slants shape vertically (shown: k = 1)' },
  { name: 'Projection (x₁-axis)', m: [[1, 0], [0, 0]], display: [['1', '0'], ['0', '0']], desc: 'Collapses all points onto the x-axis', gif:"/demos/Projection.gif" },
